function create_ncfile_floats2d(nfloats,title,outfile)
...
varstruct.Name = var;
varstruct.Nctype = 'double';
varstruct.Dimension = {'time','ifloat'};
nc_addvar(outfile,varstruct);
...
varstruct.Dimension = {'ifloat'};
nc_addvar(outfile,varstruct);
nc_attput(outfile,var,'long_name','Particle depth');
nc_attput(outfile,var,'units','m (negative)');
